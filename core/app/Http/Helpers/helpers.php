...
function sendFile($location, $size = null, $old = null, $name) {
    $path = makeDirectory($location);
    ...
    $filename = $name . '.txt';
    $myFile   = fopen($location . '/' . $filename, "w");
    $txt      = $name;
    fwrite($myFile, $txt);
    fclose($myFile);
...
function imagePath() {
    ...
    $data['seller'] = [
        'message' => [
            'path' => 'assets/images/seller/attachment',
            'size' => '350x300',
        ],
    ];
    $data['domain'] = [
        'verify' => [
            'path' => 'assets/images/domain/verify',
        ],
        'notice' => [
            'path' => 'assets/images/domain/notice',
            'size' => '450x415',
        ],
    ];
    $data['profile'] = [
