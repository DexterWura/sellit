...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $domain['soldAmount']     = Domain::where('status', 2)->sum('price');
        $domain['pendingAmount']  = Domain::where('status', 0)->sum('price');
        $domain['approvedAmount'] = Domain::where('status', 1)->sum('price');
        $domain['rejectedAmount'] = Domain::where('status', 9)->sum('price');

        return view('admin.dashboard', compact('pageTitle', 'widget', 'report', 'withdrawals', 'chart', 'payment', 'paymentWithdraw', 'depositsMonth', 'withdrawalMonth', 'months', 'deposits', 'domain'));
    }
    ...
    public function requestReport() {
        ...
        // Purchase code verification removed - returning empty reports
        $reports = [];
    ...
    public function reportSubmit(Request $request) {
        ...
        // Purchase code verification removed
